/*
 * startup.c for Projects/Secure_FW_Update
 *
 * Like App_Demo's startup, with one addition: FLASH_IRQHandler is registered
 * at vector position [16+5] (FLASH_IRQn = 5).  flash.c defines this handler
 * and uses it to signal end-of-erase / end-of-program operations.
 * The NVIC dispatch driver (nvic.c) satisfies all other IRQ externs.
 */
#include <stdint.h>
...
/* FLASH EOP/error interrupt — defined in Projects/FLASH/src/flash.c */
